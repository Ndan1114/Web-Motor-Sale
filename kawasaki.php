...
<body>
    <div class="product-list">
        <div class="product-item">
            <img src="hias/img/zx25.jpg" alt="Honda Motor">
            <h3>Ninja ZX-25R</h3>
            <p>Price : Rp 115,000,000</p>
            <a href="order.php?id=5" class="buy-button">Buy Now</a>
        </div>
        <div class="product-item">
            <img src="hias/img/h2.jpg" alt="Honda Motor">
            <h3>Ninja H2</h3>
            <p>Price : Rp 872,000,000</p>
            <a href="order.php?id=6" class="buy-button">Buy Now</a>
        </div>
    </div>
</body>
</html>
