...
<body>
    <div class="product-list">
        <div class="product-item">
            <img src="hias/img/cbr.jpg" alt="Honda Motor">
            <h3>Honda CBR 150</h3>
            <p>Price: Rp 35,000,000</p>
            <a href="order.php?id=1" class="buy-button">Buy Now</a>
        </div>
        <div class="product-item">
            <img src="hias/img/cbr250.jpg" alt="Honda Motor">
            <h3>Honda CBR 250</h3>
            <p>Price: Rp 70,000,000</p>
            <a href="order.php?id=2" class="buy-button">Buy Now</a>
        </div>
    </div>
</body>
</html>
